(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', './focus-relevant', './valid-area', './visible', './disabled', './only-tabbable', '../util/context-to-element', '../util/get-frame-element', '../util/tabindex-value', '../supports/supports'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./focus-relevant'), require('./valid-area'), require('./visible'), require('./disabled'), require('./only-tabbable'), require('../util/context-to-element'), require('../util/get-frame-element'), require('../util/tabindex-value'), require('../supports/supports'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.focusRelevant, global.validArea, global.visible, global.disabled, global.onlyTabbable, global.contextToElement, global.getFrameElement, global.tabindexValue, global.supports);
    global.focusable = mod.exports;
  }
})(this, function (module, exports, _focusRelevant, _validArea, _visible, _disabled, _onlyTabbable, _contextToElement, _getFrameElement, _tabindexValue, _supports2) {
  'use strict';
