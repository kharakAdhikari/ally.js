(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', '../util/toggle-class', '../event/shadow-focus', '../get/active-elements', '../get/parents', '../util/decorate-service', '../util/select-in-shadows', '../supports/supports'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('../util/toggle-class'), require('../event/shadow-focus'), require('../get/active-elements'), require('../get/parents'), require('../util/decorate-service'), require('../util/select-in-shadows'), require('../supports/supports'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.toggleClass, global.shadowFocus, global.activeElements, global.parents, global.decorateService, global.selectInShadows, global.supports);
    global.focusWithin = mod.exports;
  }
})(this, function (module, exports, _toggleClass, _shadowFocus, _activeElements, _parents, _decorateService, _selectInShadows, _supports2) {
  'use strict';
